...
${nuget_cmd} install src/BtApiClient/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/BtApiClient.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/BtApiClient.dll \
-recurse:'src/BtApiClient/*.cs' \
-doc:bin/BtApiClient.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/BtApiClient.dll was created successfully"
fi
